...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    BlurMaskFilter innerFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter outerFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter solidFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
    BlurMaskFilter normalFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
